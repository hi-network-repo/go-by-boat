...
function imgurl(p1) {
  if (p1 === undefined){
    ...
    return p1.replace("./", "http://s.go-boat.f5.si/go-by-boat/");
  } else if (p1.indexOf("/") === 0) {
    return p1.replace("/", "http://s.go-boat.f5.si/go-by-boat/");
  } else {
    return p1
...
const hitTemplate = function(hit) {
  ...
  return `
          ...
          <div class="row">
          <div class="col">
          <h5 class="chulapa-links-hover-only"><a href="http://s.go-boat.f5.si/go-by-boat${url}">${title}</a></h5>
          </div>
          </div>
          <div class="row mt-2">
          <div class="col">
    ...
    <article class="my-2 text-left">
      ...
      <a href="http://s.go-boat.f5.si/go-by-boat${url}">
