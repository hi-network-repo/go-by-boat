const algoliaClient = algoliasearch(
  '71SN4DFM3D',
  '95ec6d2dfb8950d622728aefafc079a2'
);
...
function imgurl(p1) {
  if (p1 === undefined){
    ...
    return p1.replace("./", "https://hi-network-repo.github.io/go-by-boat/");
  } else if (p1.indexOf("/") === 0) {
    return p1.replace("/", "https://hi-network-repo.github.io/go-by-boat/");
  } else {
    return p1
...
const hitTemplate = function(hit) {
  ...
  return `
          ...
          <div class="row">
          <div class="col">
          <h5 class="chulapa-links-hover-only"><a href="https://hi-network-repo.github.io/go-by-boat${url}">${title}</a></h5>
          </div>
          </div>
          <div class="row mt-2">
          <div class="col">
    ...
    <article class="my-2 text-left">
      ...
      <a href="https://hi-network-repo.github.io/go-by-boat${url}">
